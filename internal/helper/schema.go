...
func InitCustomSchema() {
	...
	alterWarmingSchema := `
		...
		COMMENT ON COLUMN warming_rooms.whitelisted_number IS 'Number allowed to trigger auto-reply, in bare E.164 form without a leading + (any country), or a raw LID when LID-to-phone resolution failed';
